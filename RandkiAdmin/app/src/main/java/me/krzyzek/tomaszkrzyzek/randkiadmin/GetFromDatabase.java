...
//        if(MainActivity.selectAll == true){
//            url = "http://krzyzek.me/get.php";
//        }
//        else{
//            url = "http://krzyzek.me/query.php?minWiek=" + MainActivity.minWiek + "&maxWiek=" + MainActivity.maxWiek +
//                    "&plec=" + MainActivity.plec + "&orientacja=" + MainActivity.orientacja + "&miasto=" + MainActivity.miasto;
//        }
